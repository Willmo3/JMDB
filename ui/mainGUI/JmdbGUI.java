...
//    x.addSeparator();
        ...
        selectedMoviePanel = new MediaDisplayPanel(new Movie("tt1790736", "https://m.media-amazon.com/images/M/MV5BMjE0NGIwM2EtZjQxZi00ZTE5LWExN2MtNDBlMjY1ZmZkYjU3XkEyXkFqcGdeQXVyNjMwNzk3Mjk@._V1_Ratio0.6800_AL_.jpg", "Inception: The Cobol Job", "(2010 Video)"));
        ...
        jlist.getSelectionModel().addListSelectionListener(new DisplaySelectionListener());
    }

    /**
     * Updates the displayed list of selectable nodes to display the passed list.
     *
     * @param list the movie list to update the UI with the information of
     */
    public void updateList(JList<Movie> list) {
        list.getSelectionModel().addListSelectionListener(new DisplaySelectionListener());
        jlist = list;
        scrollPane.setViewportView(jlist);
    }
     ...
     *
     * @param controller the JmdbController that this GUI sends messages to
     */
